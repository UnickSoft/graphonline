<?php
    ...
    $g_lang["save_weight_choose"] = "Gebrui waarde voor de volgende wegen";
    $g_lang["default_weight"] = "Heeft geen gewicht";
    $g_lang["browser_no_support"] = "Uw browser wordt niet ondersteund";
    $g_lang["select_and_move_objects"] = "Selecteer en verplaats objecten mbv de muis of verplaats het werkgebied";
    ...
    $g_lang["show_adjacency_matrix"] = "Afstandsmatrix";
    $g_lang["save"] = "Bewaar";
    $g_lang["cancel"] = "Annuleer";
    $g_lang["adjacency_matrix_description"] = "Zet een afstandsmatrix op. Gebruik komma \", \" als scheidingsteken";
    ...
    $g_lang["click_to_add_vertex"] = "Klik op het werkgebeid om een knoop toe te voegen. <span style=\"float:right;\">knoop nummer <select id=\"enumVertexsText\"></select></span>";
    ...
    $g_lang["short_path_result"] = "Delengte van het kortste pad is %d";
    ...
    $g_lang["bad_adj_matrix_message"] = "Kan de graaf niet creëren. Afstandsmatrix heeft het verkeerde formaat.Klik \"corrigeer matrix\" om de matrix te corrigeren of op de \"help\" knop om help te openen over het formaat van een afstandsmatrix";
    ...
    $g_lang["m_keyWords"] = "Online grafen, vindt de kortste route, visualisatie van de graaf, graaf gemaakt op basis van afstandsmatrix, afstandsmatrix, incidentiematrix, zoekfunctie verbonden componenten, Eulercircuits, minimaal  opspannende boom ";
    $g_lang["m_description"] = "Creëer een online graaf en gebruik een groot aantal algoritme's; Vindt de kortste route, vind de afstand matrix, vind de minimaal opspannende boom en mweer.";
    ...
    $g_lang["opensource_message"] = "Ons project is nu open source. Meet details...";
